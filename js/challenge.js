...
(async () => {
    ...
    app.innerHTML = '<div class="text-center py-8">Loading challenge...</div>';
    ...
    try {
        ...
        if (!challenge) {
            app.innerHTML = '<h1 class="text-red-400 text-center mt-20">Challenge not found</h1>';
            return;
        }
        ...
        app.innerHTML = `
            <div class="container mx-auto max-w-3xl p-8">
                <a class="btn mb-6" onclick="window.history.back(); return false;" href="#">← Back</a>
        ...
        app.innerHTML = `<div class="text-red-400 text-center py-8">Error loading challenge: ${error.message}</div>`;
